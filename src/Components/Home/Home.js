...
import { Button, Container, Typography, Grid, Link, Box, ImageListItem} from '@mui/material';
...
const Home = ({days}) => {
  ...
  return (
      <Container maxWidth="md" style={{ minHeight: '100vh', minWidth:'80vw', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Box style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%' }}>
          <Box style={{ flex: 1, textAlign: 'center' }}>
                    <ImageListItem>
                        <img src={logo} alt="Lociaded Logo" style={{ width: '100%', maxWidth: '440px', height: 'auto' }} />
                    </ImageListItem>
                </Box>
              <Box style={{ flex: 1, textAlign: 'left' }}>
                  ...
                  <Box m={2}>
                      <Button variant="contained"
                          style={{ borderRadius: '50px', backgroundColor: "#fff", color: 'black', height: '2.5rem', width: '50%' }}
